...
header:
  image: "/assets/images/CAF-Plan-Hero.webp"
  caption: "Photo: canva"
...
Along the way you’ll get only what you need to move:<br>
▸ A couple of **copy-paste PowerShell checks** and a **small inventory snippet** (no forms)<br>
