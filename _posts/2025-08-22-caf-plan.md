...
## Scenario: On-Prem SQL Server 2014 (End of Support) — Hybrid-first path
...
Onboard the server to **Azure Arc**, purchase/enable **ESU**, then use **Azure Update Manager** to schedule deployments and track compliance<br>
▸ **SQL Server 2014 ESU**<br>
  - **On-prem/hosted:** onboard the instance to **Azure Arc-enabled SQL Server** and subscribe ESU 
  - **In Azure (VMs/AVS/Stack):** ESU is **included**, you pay only for the Azure resources<br>
...
If not ready, **Rehost** to an **Azure VM** as a bridge while you refactor<br>
▸ **App/Web tiers:** <br>
